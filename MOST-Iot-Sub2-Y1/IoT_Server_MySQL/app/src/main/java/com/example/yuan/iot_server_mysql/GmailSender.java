...
public class GmailSender extends javax.mail.Authenticator
{
    ...
    {
        Log.i("----GmailSender----","寄email");
        this.user = user;
        this.password = password;
        Log.i("----GmailSender----",user);
        Log.i("----GmailSender----",password);
...
//                return new PasswordAuthentication(userid, passwordid);
//            }
//        });
    }
    ...
    {
        Log.i("----GmailSender----", subject);
        Log.i("----GmailSender----", body);
        Log.i("----GmailSender----", sender);
        Log.i("----GmailSender----", recipients);
        try
        {
            ...
            Log.i("----GmailSender----", String.valueOf(message));



//            ...
//            Transport transport = sessmail.getTransport("smtp");
//            transport.connect("smtp.pchome.com.tw" ,"帳號", "密碼");
//            Transport.send(msg);
        }
